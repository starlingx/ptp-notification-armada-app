...
def get_latest_offset_from_leapfile():
    ...
    """
    # In presence of a file that ts2phc is using, puppet copies that file
    # to constants.LEAP_FILE_PATH, the default path of leapfiles.
    filepath = constants.LEAP_FILE_PATH
    latest_offset = None
